...
export default class fassParser extends antlr4.Parser {
	...
	address() {
	    ...
	    try {
	        ...
	        case fassParser.HEX_BIGEND:
	            localctx = new Address_hexContext(this, localctx);
	            this.enterOuterAlt(localctx, 1);
	            this.state = 121;
	            this.hex_bigend();
	            break;
	        case fassParser.DEC_BIGEND:
	            localctx = new Address_decContext(this, localctx);
	            this.enterOuterAlt(localctx, 2);
	            this.state = 122;
	            this.dec_bigend();
	            break;
	...
	filler_stmt() {
	    ...
	    try {
	        ...
	        switch(la_) {
	        case 1:
	            localctx = new Filler_valueContext(this, localctx);
	            this.enterOuterAlt(localctx, 1);
	            this.state = 132;
	        ...
	        case 2:
	            localctx = new Filler_defaultContext(this, localctx);
	            this.enterOuterAlt(localctx, 2);
	            this.state = 134;
	            this.match(fassParser.FILLER_KWD);
	            this.state = 135;
...
class Address_decContext extends AddressContext {
	...
	enterRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.enterAddress_dec(this);
		}
	}

	exitRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.exitAddress_dec(this);
		}
	}
...
fassParser.Address_decContext = Address_decContext;

class Address_hexContext extends AddressContext {
	...
	enterRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.enterAddress_hex(this);
		}
	}

	exitRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.exitAddress_hex(this);
		}
	}
...
fassParser.Address_hexContext = Address_hexContext;
...
class Filler_valueContext extends Filler_stmtContext {
	...
	enterRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.enterFiller_value(this);
		}
	}

	exitRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.exitFiller_value(this);
		}
	}
...
fassParser.Filler_valueContext = Filler_valueContext;

class Filler_defaultContext extends Filler_stmtContext {
	...
	enterRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.enterFiller_default(this);
		}
	}

	exitRule(listener) {
	    if(listener instanceof fassListener ) {
	        listener.exitFiller_default(this);
		}
	}
...
fassParser.Filler_defaultContext = Filler_defaultContext;
